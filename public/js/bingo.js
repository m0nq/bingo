...
var _user$project$Entry$booleanDecoder = _elm_lang$core$Json_Decode$succeed(false);
var _user$project$Entry$pointsDecoder = A2(_elm_lang$core$Json_Decode$field, 'points', _elm_lang$core$Json_Decode$int);
var _user$project$Entry$phraseDecoder = A2(_elm_lang$core$Json_Decode$field, 'phrase', _elm_lang$core$Json_Decode$string);
var _user$project$Entry$idDecoder = A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int);
...
var _user$project$Entry$entryDecoder = A5(_elm_lang$core$Json_Decode$map4, _user$project$Entry$Entry, _user$project$Entry$idDecoder, _user$project$Entry$phraseDecoder, _user$project$Entry$pointsDecoder, _user$project$Entry$booleanDecoder);
...
var _user$project$ViewHelpers$alertMessage = F2(
...
var _user$project$Bingo$httpErrorToString = function (error) {
	var _p0 = error;
	switch (_p0.ctor) {
		case 'NetworkError':
			return 'Is the server running...?';
		case 'BadStatus':
			return _elm_lang$core$Basics$toString(_p0._0.status.message);
		case 'BadPayload':
...
var _user$project$Bingo$hasName = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.nameInput, '') ? A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_elm_lang$core$Native_Utils.update(
			model,
			{name: 'Anonymous', nameInput: '', gameState: _user$project$Bingo$Playing}),
		{ctor: '[]'}) : A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		_elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Bingo$initialModel = A6(
	_user$project$Bingo$Model,
	'Anonymous',
	1,
	{ctor: '[]'},
	_elm_lang$core$Maybe$Nothing,
	'',
	_user$project$Bingo$EnteringName);
...
var _user$project$Bingo$getEntries = function () {
	var entriesUrl = 'https://elm-bingo.herokuapp.com/random-entries';
	return A2(_user$project$Entry$getEntries, _user$project$Bingo$NewEntries, entriesUrl);
}();
		...
		switch (_p2.ctor) {
			case 'ChangeGameState':
				return A2(
					...
					{ctor: '[]'});
			case 'SaveName':
				return _user$project$Bingo$hasName(model);
			case 'CancelName':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'NewScore':
				...
				if (_p3.ctor === 'Ok') {
					var message = A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p3._0.score),
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								alertMessage: _elm_lang$core$Maybe$Just(
									_user$project$Bingo$httpErrorToString(_p3._0))
							}),
						{ctor: '[]'});
				}
			case 'NewGame':
				...
				if (_p4.ctor === 'Ok') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								alertMessage: _elm_lang$core$Maybe$Just(
									_user$project$Bingo$httpErrorToString(_p4._0))
							}),
						{ctor: '[]'});
				}
			case 'CloseAlert':
...
var _user$project$Bingo$generateRandomNumber = A2(
	_elm_lang$core$Random$generate,
	_user$project$Bingo$NewRandom,
	...
	return A2(
		...
		},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$ViewHelpers$alertMessage, _user$project$Bingo$CloseAlert, model.alertMessage),
					_1: {
						ctor: '::',
